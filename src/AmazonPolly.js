...
const TASK_NAME = 'AmazonPolly';
const TASK_DETAILS ='{"texttospeech":"AmazonPolly"}';
...
const Content = () => {
    ...
    return (
        <ContentLayout header={<ContentHeader title={navigationLabels.AmazonPolly.title} />}>
            <SpaceBetween size="xs">
                <ContainerHeader headerText={navigationLabels.AmazonPolly.headerText}>
